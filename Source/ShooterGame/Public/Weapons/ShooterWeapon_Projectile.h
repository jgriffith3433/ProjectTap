...
protected:
	...
	/** if the distance to the thing we are pointing at is further than this then we start a projectile */
	UPROPERTY(EditDefaultsOnly, Category = Config)
		float DistanceToProject;

	/** skip aim adjustment and just go forward */
	UPROPERTY(EditDefaultsOnly, Category = Config)
		float ProjectileAdjustRange;
