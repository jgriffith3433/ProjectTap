...
void AShooterGameState::GetLifetimeReplicatedProps( TArray< FLifetimeProperty > & OutLifetimeProps ) const
{
	...
	DOREPLIFETIME(AShooterGameState, NumEnemiesToSpawnThisWave);
	DOREPLIFETIME(AShooterGameState, NumEnemiesSpawnedThisWave);
	DOREPLIFETIME(AShooterGameState, NumEnemiesAlive);
