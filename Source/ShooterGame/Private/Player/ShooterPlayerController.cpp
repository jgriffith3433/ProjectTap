...
#define  ACH_PLAY_ALIENLAB	TEXT("ACH_PLAY_ALIENLAB")
#define  ACH_PLAY_ALIENCITY	TEXT("ACH_PLAY_ALIENCITY")
#define  ACH_PLAY_ALIENSHIP	TEXT("ACH_PLAY_ALIENSHIP")
		...
		{			
			...
			{						
				...
				{			
					...
					if (MapName.Find(TEXT("Lab")) != -1)
					{
						UpdateAchievementProgress(ACH_PLAY_ALIENLAB, 100.0f);
					}
					else if (MapName.Find(TEXT("City")) != -1)
					{
						UpdateAchievementProgress(ACH_PLAY_ALIENCITY, 100.0f);
					}
					else if (MapName.Find(TEXT("Ship")) != -1)
					{
						UpdateAchievementProgress(ACH_PLAY_ALIENSHIP, 100.0f);
					}
				}
				///////////////////////////////////////			
