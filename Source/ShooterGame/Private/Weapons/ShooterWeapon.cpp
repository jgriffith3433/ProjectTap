...
void AShooterWeapon::OnEquip(const AShooterWeapon* LastWeapon, bool stillFiring)
{
	AttachMeshToPawn();

	bPendingEquip = true;
	bWantsToFire = stillFiring;
...
bool AShooterWeapon::CanFire() const
{
	...
	bool bStateOKToFire = ((CurrentState == EWeaponState::Idle) || (CurrentState == EWeaponState::Firing) || CurrentState == EWeaponState::Equipping);
